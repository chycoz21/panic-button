    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="<?= base_url('user/dashboard') ?>"><div class="main-logo" style="color:rgb(0, 116, 48); font-size: 43px; font-family: Roboto Condensed, sans-serif; cursor: pointer;"><?= $aplikasi['logo_menu']; ?></div></a>
            </div>
            <!-- QUERY MENU -->
            <?php
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    ...
                    <div style="background-color:rgb(2, 111, 15);"><p style="text-align: center; margin: auto;padding: 10px;"><?= $m['menu']; ?></p></div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="<?= base_url('user/dashboard') ?>"><div class="main-logo" style="color:rgb(0, 116, 48); font-size: 45px; font-family: Roboto Condensed, sans-serif; cursor: pointer;"><?= $aplikasi['logo_menu']; ?></div></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    ...
                                    <!-- LOOPING MENU -->
                                    <?php foreach ($menu as $m) : ?>
                                        <li style="background-color:rgb(0, 116, 48); text-align: center; margin: auto; padding-top: 10px; padding-bottom: 10px; color: white; font-size: 18px;"><?= $m['menu']; ?></li>
                                    <!-- SIAPKAN SUB-MENU SESUAI MENU -->
                                    <?php
                                        $menuId = $m['id'];
                                        $querySubMenu = "SELECT *
